...
var ViewModel = function() {
  ...
  // Create the google map zoomed in on Manhattan
  self.initialize = function() {
    var mapCanvas = document.getElementById('google-map');
    var cenLatLng = new google.maps.LatLng(40.750547, -73.993508);
    var mapOptions = {
      center: cenLatLng,
      zoom: 10,
...
// Venue constructor to create venues & marks from the model
